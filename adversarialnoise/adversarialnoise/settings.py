"""
Django settings for adversarialnoise project.
...
INSTALLED_APPS = [
    ...
    'noise_filter.apps.NoiseFilterConfig',
    'rest_framework',
]
...
ROOT_URLCONF = 'adversarialnoise.urls'
...
WSGI_APPLICATION = 'adversarialnoise.wsgi.application'
